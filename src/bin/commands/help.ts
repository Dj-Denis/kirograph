  ...
  const groups: Group[] = [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: 'export',   args: '<build|start> [path]', desc: 'Export the graph as an interactive HTML visualization', opts: ['build [path]        Generate .kirograph/kirograph.html', 'start [path]        Generate and open in browser', '-o, --output <f>    Custom output path', '--include-contains  Include structural contains edges'] },
